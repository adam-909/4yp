...
def main(
    ...
    if experiment == "LSTM":
        architecture = "LSTM"
        lstm_time_steps = 20 #ORIGINALLY 63
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        parser.add_argument(
            ...
            type=int,
            nargs="?",
            default=2023, # exlusive, goes up to default - 1  # was 2020
        ...
        parser.add_argument(
            ...
            type=int,
            nargs="?",
            default=6, # should be end - start - 1   # was 1
